...
/**
 * sorted_list - inserts new node in sorted
 * @ht: pointer
 * @new_node: new node
 * Return: void
 */
...
/**
 * shash_table_create - function that create a sorted hash tables
 * @size: size
 *
 * Return: pointer
 */
...
/**
 * shash_table_print_rev - prints the key:value in reverse
 * @ht: pointer
 *
 * Return: void
 */
